...
const DefenderController = require('./controllers/defender_controller')
...
const position = args.position === undefined ? "fp" : args.position
...
agent.setController(new DefenderController(position, line))
