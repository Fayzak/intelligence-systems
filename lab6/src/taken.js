...
class Taken {
  ...
  getDistsAndAngles(data) {
    ...
    for (const obj of data) {
      ...
      dists_and_angles["all_flags"][obj_name] = {
        dist: obj["p"][0],
        angle: obj["p"][1],
        x: Flags[obj_name]["x"],
        y: Flags[obj_name]["y"],
  ...
  getPlayersXY(arr_key, e0, flag1, coords) {
    for (let i = 0; i < this.state[arr_key].length; i++) {
      ...
      let player_coords = utils.get_object_coords(
        flag1[2],
        object[0],
        coords[0],
        coords[1],
  ...
  writeSeeData(data) {
    ...
    if (coords) {
      ...
      if (dists_and_angles["ball"]) {
        ...
        ball_coords = utils.get_object_coords(
          flag1[2],
          object[0],
          coords[0],
          coords[1],
      ...
      if (dists_and_angles["player"]) {
        ...
        player_coords = utils.get_object_coords(
          flag1[2],
          object[0],
          coords[0],
          coords[1],
